...
![Finance Dashboard Landing Page](./docs/images/landing-page-screenshot.png)
...
The application will be available at `http://localhost:3002` (or the port specified in your `.env` file).
...
- Solution: Use port 3002 (set `PORT=3002` in `.env`)
